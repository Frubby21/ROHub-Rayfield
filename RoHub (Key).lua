...
local Information = Window:CreateTab("Information", "i") -- Title, Image
...
local Settings = Window:CreateTab("Settings", "cogwheel") -- Title, Image

local Button = Settings:CreateButton({
   Name = "Close Rayfield Interface (DESTROYS UI)",
   Callback = function()
